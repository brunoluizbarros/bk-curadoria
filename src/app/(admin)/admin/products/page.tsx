import { getProductsAdminPaginated } from "@/server/queries/products";
...
export default async function ProductsPage({
  ...
  const { items: products, total } = await getProductsAdminPaginated(page, LIMIT);
    ...
    <div>
      ...
      {products.length === 0 ? (
        ...
        <>
          ...
          <Pagination page={page} totalPages={totalPages} baseHref="/admin/products" />
        </>
      )}
    </div>
  );
