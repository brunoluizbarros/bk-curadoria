      ...
      <div className="max-w-screen-xl mx-auto md:grid md:grid-cols-2 md:gap-16 md:items-start">
        ...
        <div>
          ...
          {quote && (
            <blockquote className="border-l-2 border-gold pl-4">
              <p className="font-display font-300 italic text-lg md:text-2xl lg:text-3xl text-ink leading-relaxed">
                &ldquo;{quote}&rdquo;
              </p>
            </blockquote>
          )}
        ...
        {body && (
          <div className="mt-5 md:mt-6">
            <p className="font-body font-300 text-sm leading-relaxed text-ink-soft">{body}</p>
          </div>
        )}
      </div>
    </section>
